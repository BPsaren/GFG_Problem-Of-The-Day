...
class Solution {
  public:
    int minValue(Node* root) {
        // Code here
        // Base case: if the root is null, return the maximum possible integer value
    if (root == nullptr) {
        return INT_MAX;
    }
    ...
    // Compare the minimum value of the current node with the minimum values from its subtrees
